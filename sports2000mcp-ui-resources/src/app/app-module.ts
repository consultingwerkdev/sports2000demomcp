...
import { Sports2000McpShowCustomerFormLogic } from './form-logic-classes/show-customer/show-customer-form-logic/show-customer-logic';
...
import { Sports2000McpShowCustomerViewerLogic } from './form-logic-classes/show-customer/show-customer-viewer-logic/show-customer-viewer-logic';

/**
 * Declares the Angular module for the Sports2000 MCP customer shell.
 *
 * @memberof AppModule
 */
@NgModule({
